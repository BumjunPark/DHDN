...
parser.add_argument("--model1", default="./retrain/gaus_c_50.pth", type=str, help="Model path")
parser.add_argument("--model2", default="", type=str, help="Model path for model ensemble")
parser.add_argument("--data", default="./data/noisy_kodak_nl50_c.mat", type=str, help="Test data path")
